...
(function() {
  var GAME_RESULT, PLAYER_ROLES, Sequelize, computePersonalAsync, db, rating;
  ...
  computePersonalAsync = async function(playerName, done) {
    var bestMoveAttempts, delta, err, foundedMafiaOnBestMove, games, i, j, k, pg, player, playerGame, playerGames, profile, ref, ref1, ref2, ref3, result;
    try {
      profile = {
        "name": "",
        "rating": 0,
