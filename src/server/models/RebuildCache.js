...
(function() {
  var GAME_RESULT, PLAYER_ROLES, Sequelize, comparator, db, fs, rating, rebuildCacheAsync;
  ...
  rebuildCacheAsync = async function(done) {
    var cachedPlayer, chainerResults, commonStats, err, game, i, isWinner, j, k, l, len, len1, name, names, player, playerGame, playerGames, playerName, promisingWriteFiles, ref, result, top10, wins;
    try {
